...
for texture in textures:
	...
	hist_ref, _=np.histogram(lbp, bins=2**numPoints, range=(0, 2**numPoints)) #Fonction de numpy histogram   #bin le nombre des points que je veux recupere dans l'histogramme
